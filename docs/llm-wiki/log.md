...
relations.md の親草案を確定版へ訂正した（親: agent-pm）。

**Verification**: contracts registry `registry/organization/repositories/agent-pm-docs.yaml` の spec.parent と一致することを確認（contracts commit ecbc226、validate/lint 0 errors 済み）。
